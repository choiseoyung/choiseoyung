...
# 영상처리 메뉴에서 "영상흐리기"를 선택했을 때 호출되는 함수
# def image_blur():
#     global im, tk_img
...
# 영상처리 메뉴에서 "흑백영상"을 선택했을 때 호출되는 함수
# def image_grayscale():
#     global im, tk_img
#     im1 = im.convert('L')
...
# 영상처리 메뉴에서 "이진화"를 선택했을 때 호출되는 함수
# def image_bin():
#     global im, tk_img
#     im1 = im.convert('1')
#     tk_img = ImageTk.PhotoImage(im1)
...
# 영상처리 메뉴에서 "영상뚜렷하게"를 선택했을 때 호출되는 함수
# def image_sharp():
#     global im, tk_img
...
# 영상처리 메뉴에서 "엠보스"를 선택했을 때 호출되는 함수
# def image_emboss():
#     global im, tk_img
...
# ipmenu.add_command(label="흑백영상", commad=image_grayscale)
